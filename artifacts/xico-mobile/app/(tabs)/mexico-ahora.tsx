...
const s = StyleSheet.create({
  ...
  mastheadTitle: { fontFamily: "Newsreader_300Light", fontSize: 48, lineHeight: 44, color: Colors.textPrimary, letterSpacing: -1 },
  mastheadItalic: { fontFamily: "Newsreader_300Light_Italic", fontStyle: "italic" },
