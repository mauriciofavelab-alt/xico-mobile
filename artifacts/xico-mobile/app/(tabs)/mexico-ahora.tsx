...
const cx = StyleSheet.create({
  ...
  rate: { fontFamily: "Inter_400Regular", fontSize: 11, color: "rgba(255,255,255,0.25)", letterSpacing: 0.5 },
  ...
  col: { flex: 1 },
  colLabel: { fontFamily: "Inter_600SemiBold", fontSize: 11, letterSpacing: 2, color: "rgba(255,255,255,0.25)", textTransform: "uppercase", marginBottom: 8 },
...
const s = StyleSheet.create({
  ...
  agendaTagRight: { fontFamily: "Inter_400Regular", fontSize: 11, letterSpacing: 2, color: "rgba(255,255,255,0.35)", textTransform: "uppercase" },
  ...
  featuredMeta: { fontFamily: "Inter_400Regular", fontSize: 11, color: "rgba(255,255,255,0.3)", letterSpacing: 2, textTransform: "uppercase", marginBottom: 12 },
