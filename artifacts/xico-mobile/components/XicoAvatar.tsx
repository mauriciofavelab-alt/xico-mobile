...
export function XicoAvatar({ level, size = 72 }: { level: XicoLevel; size?: number }) {
  ...
  if (n === "Semilla") return <SemillaAvatar color={level.color} size={size} />;
  if (n === "Guardián") return <GuardianAvatar color={level.color} size={size} />;
  if (n === "Anciano") return <AncianoAvatar color={level.color} size={size} />;
